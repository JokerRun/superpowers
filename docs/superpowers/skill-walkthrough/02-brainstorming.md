...
3. On your next turn — read .events file and merge with terminal text
4. Iterate or advance
5. Unload when returning to terminal
6. Repeat until done

## Writing Content Fragments / CSS Classes / Browser Events / Design Tips / File Naming / Cleaning Up

[完整参考原文 skills/brainstorming/visual-companion.md]
```
